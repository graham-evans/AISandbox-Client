...
public class POJOTests {
    ...
    public void MazeRequest() {
        assertPojoMethodsFor(MazeRequest.class).testing(Method.GETTER, Method.SETTER).areWellImplemented();
    }

    @Test
    public void MazeResponse() {
        assertPojoMethodsFor(MazeResponse.class).testing(Method.GETTER, Method.SETTER).areWellImplemented();
    }
