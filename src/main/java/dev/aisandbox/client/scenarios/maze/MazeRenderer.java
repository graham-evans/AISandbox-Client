...
public class MazeRenderer {
    ...
    public BufferedImage renderMaze(Maze maze) {
        ...
        if (start != null) {
            g.drawImage(sprites.get(17), start.getPositionX() * SCALE, start.getPositionY() * SCALE, null);
        }
        Cell finish = maze.getEndCell();
        if (finish != null) {
            g.drawImage(sprites.get(18), finish.getPositionX() * SCALE, finish.getPositionY() * SCALE, null);
        }
        return image;
    }
