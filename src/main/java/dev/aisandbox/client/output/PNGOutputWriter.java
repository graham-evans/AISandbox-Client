 ...
 * <p>
 * A new directory will be created and each frame will be written as a file nnnnnnnn.PNG
 */
@Component
public class PNGOutputWriter implements FrameOutput {
     ...
     * <p>
     * This is used when Spring initialises all available implementations of {@link FrameOutput} and displays them on the UI
     ...
     *
     * @param baseDir The root directory - multiple runs will create multiple entries in this directory.
     * @throws IOException thrown if the directory can't be created, or if open is called twice without closing.
     */
    @Override
